...
import { FiGithub, FiLinkedin, FiCpu, FiShield, FiActivity, FiArrowUpRight, FiMail } from 'react-icons/fi';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 md:gap-8">
          ...
          >
            <div className="flex items-center space-x-3 group cursor-pointer">
              ...
              <h3 className="text-2xl font-black text-white tracking-tighter uppercase italic">
                SAHITYA<span className="text-cyan-600">.</span>
              </h3>
            </div>
            <p className="text-gray-500 text-xs leading-relaxed uppercase tracking-widest font-light">
              Mathematics graduate pursuing MSc in Data Science and AI. Building intelligent systems that solve real problems.
            </p>
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              {['Python', 'PyTorch', 'Scikit-Learn', 'TensorFlow', 'Spark'].map((tech) => (
            ...
            <div className="pt-4 space-y-2">
              <div className="flex items-center space-x-2 text-[9px] text-gray-600 tracking-widest uppercase">
                ...
                <span>GATE 2025 Qualified</span>
              </div>
              <div className="flex items-center space-x-2 text-[9px] text-gray-600 tracking-widest uppercase">
                <FiActivity className="text-cyan-500/40" />
                <span>IYMC Bronze Honour</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <motion.a
              href="mailto:hereissahityadeybiswas@gmail.com"
        ...
        <div className="mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col items-center md:items-end">
             ...
             <p className="text-[9px] text-gray-700 tracking-[0.2em] font-mono uppercase">
                &copy; SAHITYA BISWAS. ALL NEURAL LINKS RESERVED.
             </p>
          </div>
        </div>
      </div>
