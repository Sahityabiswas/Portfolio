      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 p-6 md:p-8 lg:p-10">
          ...
          <div className="flex items-baseline gap-3 mb-2">
            <h3 className="text-3xl md:text-4xl lg:text-5xl font-black text-white tracking-tighter uppercase shrink-0">
              {project.title}<span className="text-blue-500">.</span>
            </h3>
            <span className="text-gray-400 text-xs md:text-sm font-light tracking-wide hidden sm:inline">
              {project.subtitle}
            </span>
          </div>
          <p className="sm:hidden text-gray-400 text-xs font-light tracking-wide mb-2">
            {project.subtitle}
          </p>
